...
IL_0019:
	{
		...
		NullCheck(L_2);
		TeleportEventData_Initialize_m120C551CE02A48A8EE9E2C4D63284410FFA7CDC6(L_2, L_3, L_4, /*hidden argument*/NULL);
		...
		MixedRealityTeleportSystem_ProcessTeleportationRequest_mA12C301E9623A07B258956408BECD333192D9F39(__this, L_7, /*hidden argument*/NULL);
	}
...
IL_003a:
	{
		...
		NullCheck(L_8);
		RuntimeObject* L_9 = TeleportEventData_get_Pointer_mCDDF54763C1768CFC0AB173BE1E42C04A77B8FA0_inline(L_8, /*hidden argument*/NULL);
		NullCheck(L_9);
		...
		V_3 = L_11;
		Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720  L_12 = FocusDetails_get_Point_m09947F8B43E09601ACC2F7C9AAE342A1D14CA6BE_inline((FocusDetails_t18BF71E2C4DCC7032FE6F741ECF683D226A9F590 *)(&V_3), /*hidden argument*/NULL);
		__this->set_targetPosition_16(L_12);
		// if (eventData.HotSpot != null)
		TeleportEventData_tF7B1BC8E1FC714B772561C26255C0DCD5C7B9F94 * L_13 = ___eventData0;
		NullCheck(L_13);
		RuntimeObject* L_14 = TeleportEventData_get_HotSpot_mED4178A7CC02A4AEBB90D40B2091384EF8FE169A_inline(L_13, /*hidden argument*/NULL);
	...
	}
	{
		...
		NullCheck(L_16);
		RuntimeObject* L_17 = TeleportEventData_get_HotSpot_mED4178A7CC02A4AEBB90D40B2091384EF8FE169A_inline(L_16, /*hidden argument*/NULL);
		NullCheck(L_17);
		...
		NullCheck(L_19);
		RuntimeObject* L_20 = TeleportEventData_get_HotSpot_mED4178A7CC02A4AEBB90D40B2091384EF8FE169A_inline(L_19, /*hidden argument*/NULL);
		NullCheck(L_20);
	...
	}
	{
		...
		NullCheck(L_24);
		RuntimeObject* L_25 = TeleportEventData_get_HotSpot_mED4178A7CC02A4AEBB90D40B2091384EF8FE169A_inline(L_24, /*hidden argument*/NULL);
		NullCheck(L_25);
...
IL_00a3:
	{
		...
		MixedRealityPlayspace_set_Position_m92D2F676D481084491194B207C9DFDFDF67EF94F(L_38, /*hidden argument*/NULL);
		...
		MixedRealityPlayspace_RotateAround_m55161196CBBB0EE476946CDCAA197F71EE8740C1(L_41, L_42, ((float)il2cpp_codegen_subtract((float)L_44, (float)L_48)), /*hidden argument*/NULL);
		...
		NullCheck(L_49);
		RuntimeObject* L_50 = TeleportEventData_get_Pointer_mCDDF54763C1768CFC0AB173BE1E42C04A77B8FA0_inline(L_49, /*hidden argument*/NULL);
		TeleportEventData_tF7B1BC8E1FC714B772561C26255C0DCD5C7B9F94 * L_51 = ___eventData0;
		NullCheck(L_51);
		RuntimeObject* L_52 = TeleportEventData_get_HotSpot_mED4178A7CC02A4AEBB90D40B2091384EF8FE169A_inline(L_51, /*hidden argument*/NULL);
		MixedRealityTeleportSystem_RaiseTeleportComplete_mCC24FA3FEA09A283AE837CE28508916F3B38A803(__this, L_50, L_52, /*hidden argument*/NULL);
		// }
		return;
	}
}
