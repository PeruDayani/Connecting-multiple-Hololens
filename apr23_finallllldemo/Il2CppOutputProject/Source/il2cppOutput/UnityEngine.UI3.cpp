...
IL_0063:
	{
		...
		bool L_33 = Slider_get_reverseValue_mC323FAACCF39EECD0D66012C8A455D2CB8135154(__this, /*hidden argument*/NULL);
		G_B9_0 = __this;
		if (L_33)
		{
			G_B10_0 = __this;
...
IL_00ce:
	{
		NullCheck(G_B11_1);
		Slider_set_normalizedValue_mF932B150739F3C38E125175E81FD7C0F11C44A23(G_B11_1, G_B11_0, /*hidden argument*/NULL);
	}
...
IL_0078:
	{
		...
		Slider_UpdateDrag_m48423493426B22F202FC78B7AF92B95398111E9B(__this, L_22, L_24, /*hidden argument*/NULL);
	}
...
IL_001c:
	...
	}
	{
		...
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_11, NULL, ToggleGroup_ValidateToggleIsInGroup_mD4CA76641EF05E60429FFF845F19D107C603627D_RuntimeMethod_var);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void VertexHelper_FillMesh_mBA946D1CEDC24DCCD8A593CF77D0B54D14FDB74B (VertexHelper_t27373EA2CF0F5810EC8CF873D0A6D6C0B23DAC3F * __this, Mesh_t6106B8D8E4C691321581AB0445552EC78B947B8C * ___mesh0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_4, NULL, VertexHelper_FillMesh_mBA946D1CEDC24DCCD8A593CF77D0B54D14FDB74B_RuntimeMethod_var);
	}
